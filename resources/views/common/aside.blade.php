<aside class="left-sidebar side-menu">
  <!-- Sidebar scroll-->
  <div class="scroll-sidebar">
      ...
      <nav class="sidebar-nav">
          <ul id="sidebarnav">
              ...
              <li class="nav-small-cap">--- Management Channel</li>
              <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Management <span class="badge badge-pill badge-cyan ml-auto">4</span></span></a>
                  <ul aria-expanded="false" class="collapse">
                      <li><a href="index.html">Test </a></li>
                      <li><a href="index2.html">Test</a></li>
                      <li><a href="index3.html">Test</a></li>
                      <li><a href="index4.html">Test</a></li>
                  </ul>
              </li>
